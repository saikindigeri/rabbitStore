    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <p className="font-medium text-sm text-gray-600 mt-6">Sign up and get 10% off your first order.</p>
          {/* News ltter */}
          <form className="flex">
            <input
              type="email"
        ...
        {/* Follow us */}
        <div>
            <h3 className="text-lg text-gray-300 mb-4 ">Follow Us</h3>
         ...
         <p className="text-gray-50">Call Us </p>
         <p>
